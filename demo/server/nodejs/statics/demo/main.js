  ...
  baseUrl : "./",
    paths: {
      ...
      packages: [
         ...
         {
           name : "skylark-domx-effects",
           location : "../node_modules/skylark-domx-effects/dist/uncompressed/skylark-domx-effects",
            main: 'main'
         },
         {
...
require(["skylark-jquery"], function ($) {
    require(["skylark-elfinder"], function (elFinder) {
        if (window.initPage) {
            window.initPage($,elFinder);
        }
    });
});